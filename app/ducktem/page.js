  ...
  return (
    <div className="min-h-screen bg-[#FFF9E6] text-[#333]">
      ...
      <header className="bg-yellow-400 p-8 rounded-b-[3rem] shadow-lg">
        <div className="max-w-6xl mx-auto flex justify-between items-center">
          ...
          <nav className="flex gap-4">
            <Link href="/ducktem/goods" className="px-6 py-3 bg-white rounded-2xl font-black hover:scale-105 transition-transform shadow-sm">
              굿즈 탐색
            </Link>
            <Link href="/ducktem/calendar" className="px-6 py-3 bg-white rounded-2xl font-black hover:scale-105 transition-transform shadow-sm">
              이벤트 달력
            </Link>
          </nav>
        </div>
      ...
      <footer className="p-12 text-center text-gray-400 font-bold text-sm">
        © 2024 DUCKTEM. All rights reserved. 🦆
      </footer>
    </div>
  );
}
